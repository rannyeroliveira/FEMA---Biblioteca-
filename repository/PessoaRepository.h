...
private:
    ...
    void populaVetor() {
        ...
        tabelaDePessoas[5] = Pessoa(6, (char*)"Paula",    (char*)"52998224725", "Rua F", 106);   // válido
        tabelaDePessoas[6] = Pessoa(7, (char*)"Fernanda", (char*)"52998224725", "Rua G", 107);   // válido
        tabelaDePessoas[7] = Pessoa(8, (char*)"Lucas",    (char*)"52998224725", "Rua H", 108);   // válido
        tabelaDePessoas[8] = Pessoa(9, (char*)"Mateus",   (char*)"52998224725", "Rua I", 109);   // válido
        tabelaDePessoas[9] = Pessoa(10, (char*)"Julia",   (char*)"52998224725", "Rua J", 110);   // válido
